...
/// <summary>
/// Background audio player implemented using WASAPI.
/// </summary>
/// <remarks>
/// This is the preferred audio system when running on Windows.
/// </remarks>
...
public sealed class WasapiAudioPlayer : AudioPlayer
{
    ...
    /// <summary>
    /// Returns a new <see cref="WasapiAudioPlayer"/> with the specified settings.
    /// </summary>
    ...
    /// <returns><see cref="WasapiAudioPlayer"/> instance.</returns>
    public static WasapiAudioPlayer Create(TimeSpan bufferLength, bool useCallback = false, AudioFormat? format = null)
    {
        var client = MediaDevice.Default.CreateAudioClient();
        try
        {
            client.Initialize(bufferLength, format, useCallback);
